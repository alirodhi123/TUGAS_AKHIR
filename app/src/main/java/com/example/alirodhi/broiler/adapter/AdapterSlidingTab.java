...
import com.example.alirodhi.broiler.fragment.LogSensorFragment;
...
public class AdapterSlidingTab extends FragmentStatePagerAdapter {
    ...
    public Fragment getItem(int position) {
        ...
        {
            LogSensorFragment logSensorFragment = new LogSensorFragment();
            return logSensorFragment;
        }
        else             // As we are having 2 tabs if the position is now 0 it must be 1 so we are returning second tab
        {
            LogRelayFragment logRelayFragment = new LogRelayFragment();
            return logRelayFragment;
        }
